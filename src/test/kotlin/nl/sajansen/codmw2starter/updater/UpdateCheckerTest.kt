...
class UpdateCheckerTest {
    ...
    fun `test getRemoteTags returns a list of tags from a JSON response`() {
        ...
        `when`(urlMock.readText(anyString())).thenReturn(
            """
            {
              "url": "https://api.github.com/repos/sampie777/cod-mw2-starter/releases/32548939",
              "assets_url": "https://api.github.com/repos/sampie777/cod-mw2-starter/releases/32548939/assets",
              "html_url": "https://github.com/sampie777/cod-mw2-starter/releases/tag/v2.7.0",
              "tag_name": "v2.7.0",
    ...
    fun `test isNewUpdateAvailable returns false when latest version is different but already known`() {
        ...
        `when`(urlMock.readText(anyString())).thenReturn(
            """
            {
              "url": "https://api.github.com/repos/sampie777/cod-mw2-starter/releases/32548939",
              "assets_url": "https://api.github.com/repos/sampie777/cod-mw2-starter/releases/32548939/assets",
              "html_url": "https://github.com/sampie777/cod-mw2-starter/releases/tag/v999.7.0",
              "tag_name": "v999.7.0",
              "target_commitish": "master",
              "name": "v999.7.0",
              "draft": false,
    ...
    fun `test isNewUpdateAvailable returns false when latest version is not different but unknown`() {
        ...
        `when`(urlMock.readText(anyString())).thenReturn(
            """
            {
              "url": "https://api.github.com/repos/sampie777/cod-mw2-starter/releases/32548939",
              "assets_url": "https://api.github.com/repos/sampie777/cod-mw2-starter/releases/32548939/assets",
              "html_url": "https://github.com/sampie777/cod-mw2-starter/releases/tag/v${ApplicationInfo.version}",
